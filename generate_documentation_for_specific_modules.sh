...
swift doc generate Sources/Common --module-name SurfGen --output Sources/Common/Docs --base-url=./Docs
...
swift doc generate Sources/GASTBuilder --module-name SurfGen --output Sources/GASTBuilder/Docs --base-url=./Docs
